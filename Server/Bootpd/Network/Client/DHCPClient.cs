...
namespace Bootpd.Network.Client
{
	public sealed class DHCPClient : BaseClient
	{
		...
		public DHCPClient(ServerType serverType, bool localInstance) : base(serverType, localInstance)
		{
		...
		public override void HeartBeat()
		{
			...
			packet.AddOption(new Common.Network.Protocol.DHCP.DHCPOption(94, new byte[3] { 0x01, 0x02, 0x0b }));
