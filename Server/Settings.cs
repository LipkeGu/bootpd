namespace Server.Network
{
	...
	public static class Settings
	{
		...
		public static string ServerDomain = "FBLIPKE";
		public static string UserDNSDomain = "ad.fblipke.de";
