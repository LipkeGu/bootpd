namespace Bootpd
{
	...
	public static class Exts
	{
		...
		public static string AsString(this byte[] input, int index = 0, string delimeter = "")
		{
			var value = new byte[input.Length];
			Functions.CopyTo(input, index, value, 0, value.Length);
		...
		public static byte[] SetDHCPOption(byte option, byte[] value, bool includesendoption = false)
		{
			...
			opt[1] = len;
			Functions.CopyTo(value, 0, opt, 2, opt.Length - 2);
