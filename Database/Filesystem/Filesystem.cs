namespace Server.Extensions
{
	...
	public static class Filesystem
	{
		...
		{
			var givenPath = ReplaceSlashes(StripRoot(path.ToLowerInvariant(), directory));
			...
			return Path.Combine(directory, givenPath);
		}

		public static string ResolvePath(string path)
		{
			var givenPath = ReplaceSlashes(path.ToLowerInvariant());
