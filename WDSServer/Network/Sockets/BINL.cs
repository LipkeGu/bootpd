...
{
	sealed public class BINLSocket : SocketProvider
	{
		...
		public BINLSocket(IPEndPoint endpoint, bool broadcast = false, bool enableMulticast = false, int buffersize = 1024,
			SocketType type = SocketType.BINL)
		{
			try
			{
